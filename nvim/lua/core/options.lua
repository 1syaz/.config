vim.cmd([[autocmd FileType * set formatoptions-=ro]]) -- turn off auto commenting
...
vim.o.ignorecase = true -- Case-insensitive searching UNLESSS \C or capital in search
vim.o.smartcase = true -- only upper case when upper case letter in search
